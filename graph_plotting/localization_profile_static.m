...
strainFolder = 'Jenal FimW'; % IMPORTANT!!! must match exactly the folder name, folder must contains "data" and "final_figure" folder, "data" must contain "Input_Profile_Analysis.xlsx"
...
only_plot = 0;
load_name = 'Data_'; % 'Data_Name' no .mat at the end
dir_data=strcat("G:\Marco\bs_locprof_data_storage\",strainFolder);
dir_save_mat = strcat("G:\Marco\bs_locprof_data_storage\",strainFolder,"\mat");
dir_save_graph = strcat("G:\Marco\bs_locprof_results\",strainFolder);
...
if ~only_plot
    ...
    % load functions
    dir_func = 'C:\Users\mkuehn\git\bs_locprof\Functions';
    addpath(dir_func);
