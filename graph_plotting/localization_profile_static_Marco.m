...
strainFolder = 'ChpB'; % IMPORTANT!!! must match exactly the folder name, folder must contains "data" and "final_figure" folder, "data" must contain "Input_Profile_Analysis.xlsx"
...
dir_data=strcat("/Volumes/Plab-Data/Marco/bs_locprof_data_storage/",strainFolder);
dir_save_mat = strcat("/Volumes/Plab-Data/Marco/bs_locprof_data_storage/",strainFolder,"/mat");
dir_save_graph = strcat("/Volumes/Plab-Data/Marco/bs_locprof_results/",strainFolder);
